...
data={'pin':'1234','account.no':'779484173712','phone.no':'+918247343944','amount':10000}
...
def sms(body,phone):
    account_sid='AC59ec424f5fc35a684d0a2ad7202a990d'
    auth_token='2d18cd3f0cbdd15da296e6dd285cab1d'
    client=Client(account_sid,auth_token)
    message=client.messages.create(body=body,from_='+17576635449',to=phone)
    print(message.sid)
